...
export function meta(_: Route.MetaArgs) {
  return [
    ...buildMeta({
      title: "Om os — Define Cleaning A/S",
      description:
...
const pageSchema = {
  ...
  "@type": "WebPage",
  name: "Om os – Define Cleaning A/S",
  description: "Lær Define Cleaning A/S at kende.",
  url: PAGE_URL,
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
        ...
        <section className="wrap" style={{ paddingBottom: "var(--pad-section)" }}>
          <div className="story">
            ...
            <div className="reveal d1">
              ...
              <p>
                Define Cleaning blev grundlagt af to fagfolk med en simpel idé: rengøring skal være
